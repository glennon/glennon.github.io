...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: (
      <div className="space-y-10">
        <section>
          <h3 className="text-2xl font-medium mb-4 font-serif text-[#1A2F25] italic">Fox Run</h3>
          <p className="text-[#44403C] font-light mb-4">
            I vibe-coded an original, retro-style, browser game called Fox Run. It is inspired by 80s classics Pac-Man and Rally-X. In Fox Run, you play as a fox trying to collect berries while evading some not-so-friendly red dogs.
          </p>

          {/* IMAGE EMBED */}
          {/* Make sure the src matches the exact filename you put in public/posts/ */}
          <div className="my-6">
            <img
              src="/posts/foxrun-gameplay.png"
              alt="Fox Run Gameplay"
              className="w-full rounded-md shadow-md"
            />
          </div>

          <p className="text-[#44403C] font-light mb-4">
            It is free to play. Mobile users will see on-screen controls, and laptop users can navigate with the arrow keys. Because the game resides all within a single 63MB file, on first load, it may take 15+ seconds to start.
          </p>

          <p>I created Fox Run in March, as an experiment to test out best practices for building with generative AI. I used Gemini Pro for the code, Suno for the music, Nano-Banana for the splash art, and Logic Pro for the sound effects. It's still a work in progress with a few updates planned, but it's totally playable today. Have fun!</p>

          {/* LINK TO THE GAME */}
          <p>
            <a href="/games/foxrun.html">
              <b>Play Fox Run</b>
            </a>
          </p>
        </section>
